...
int main(void)
{
  ...
  RUN_TEST(test_gsmStartUp, 143);
  RUN_TEST(test_gsmExitDataMode, 170);
  RUN_TEST(test_gsmSysTickHandler, 194);
  RUN_TEST(test_gsmProcess, 241);
  RUN_TEST(test_gsmIsIdle, 316);
  RUN_TEST(test_gsmGetSigQual, 347);
  RUN_TEST(test_gsmCheckConn, 373);
  RUN_TEST(test_gsmReadUrc, 399);
  RUN_TEST(test_gsmSetUrcMode, 453);
  RUN_TEST(test_gsmSetUrcCback, 479);
  RUN_TEST(test_gsmSetDataCback, 501);
  RUN_TEST(test_gsmCheckDataMode, 523);
  RUN_TEST(test_gsmSmsSend, 579);
  RUN_TEST(test_gsmSmsRead, 607);
  RUN_TEST(test_gsmSmsList, 635);
  RUN_TEST(test_gsmSmsDel, 663);
  RUN_TEST(test_gsmGprsStart, 689);
  RUN_TEST(test_gsmGprsStop, 715);
  RUN_TEST(test_gsmGprsOpenPort, 739);
  RUN_TEST(test_gsmGprsClosePort, 765);
  RUN_TEST(test_gsmGnssPwr, 789);
  RUN_TEST(test_gsmGnssGetData, 815);
  RUN_TEST(test_gsmStartUpF, 847);
  RUN_TEST(test_gsmExitDataModeF, 1006);
  RUN_TEST(test_gsmGetSigQualF, 1062);
  RUN_TEST(test_gsmCheckConnF, 1262);
  RUN_TEST(test_gsmSmsSendF, 1374);
  RUN_TEST(test_gsmSmsReadF, 1495);
  RUN_TEST(test_gsmSmsListF, 1601);
  RUN_TEST(test_gsmSmsDelF, 1856);
  RUN_TEST(test_gsmGprsStartF, 1937);
  RUN_TEST(test_gsmGprsStopF, 2112);
  RUN_TEST(test_gsmGprsOpenPortF, 2195);
  RUN_TEST(test_gsmGprsClosePortF, 2322);
  RUN_TEST(test_gsmGnssPwrF, 2374);
  RUN_TEST(test_gsmGnssGetDataF, 2453);
