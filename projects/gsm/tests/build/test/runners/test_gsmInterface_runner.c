...
int main(void)
{
  ...
  RUN_TEST(test_gsmExitDataModeF, 1005);
  RUN_TEST(test_gsmGetSigQualF, 1061);
  RUN_TEST(test_gsmCheckConnF, 1261);
  RUN_TEST(test_gsmSmsSendF, 1373);
  RUN_TEST(test_gsmSmsReadF, 1494);
  RUN_TEST(test_gsmSmsListF, 1600);
  RUN_TEST(test_gsmSmsDelF, 1855);
  RUN_TEST(test_gsmGprsStartF, 1936);
  RUN_TEST(test_gsmGprsStopF, 2111);
  RUN_TEST(test_gsmGprsOpenPortF, 2194);
  RUN_TEST(test_gsmGprsClosePortF, 2418);
  RUN_TEST(test_gsmGnssPwrF, 2503);
  RUN_TEST(test_gsmGnssGetDataF, 2710);
